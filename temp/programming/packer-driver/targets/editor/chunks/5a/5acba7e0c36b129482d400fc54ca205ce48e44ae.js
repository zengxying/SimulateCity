      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        ...
        onEnable() {
          (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
            ...
            error: Error()
          }), MsgEvent) : MsgEvent).OP_TOUCH_MOVE, this.moveView2.bind(this)); // Msg.on(MsgEvent.OP_TOUCH_ROTA, this.rotaView.bind(this));
...
//# sourceMappingURL=5acba7e0c36b129482d400fc54ca205ce48e44ae.js.map