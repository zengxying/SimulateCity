    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        testRotaPos(radian) {
          ...
          const localPosition = this.originPos.subtract(this._centerPoint); // 计算旋转后的位置  每次旋转的值加上本身的旋转度数
...
//# sourceMappingURL=0428a77c8b8801a882bc0c2bcb6b7f01ea2a6dec.js.map