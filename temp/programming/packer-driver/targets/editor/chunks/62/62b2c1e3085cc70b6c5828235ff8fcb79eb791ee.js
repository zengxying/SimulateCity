System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CameraComponent, Component, Quat, Vec2, Vec3, GlobalConst, Msg, MsgEvent, Log, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, v2_1, v2_2, v3_1, qt_1, forward, right, CameraControllerComp;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        slide: true,
        range: [0.05, 0.5, 0.01]
      }), _dec(_class = (_class2 = class CameraControllerComp extends Component {
        constructor(...args) {
          super(...args);
          this._camera = void 0;
        ...
        rotaView(vec2) {
          ...
          if (this._eulerP.x + x < 90 && this._eulerP.x + x > 30) {
            // x处角度的旋转限制 测试使用
            this._eulerP.x += x;
          }
...
//# sourceMappingURL=62b2c1e3085cc70b6c5828235ff8fcb79eb791ee.js.map