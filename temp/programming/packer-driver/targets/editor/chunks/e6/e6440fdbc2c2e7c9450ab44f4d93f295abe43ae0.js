    ...
    execute: function () {
      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        ...
        moveView(vec2) {
          ...
          this._velocity.set(vec2.x, vec2.y, 0); // this._camera.screenToWorld(this._velocity,this._velocity);
        ...
        static test(vec2) {
          console.log("转换出来的坐标:vec2 vec2", vec2.x, vec2.y);
          (_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
            error: Error()
          }), v3_2) : v3_2).set(vec2.x, vec2.y, 0);

          this.ins._camera.screenToWorld(_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
            error: Error()
          }), v3_2) : v3_2, _crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1);

          console.log("转换出来的坐标:", (_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1).x, (_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
        ...
        update(dt) {
          ...
          const moveDir = (_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
            error: Error()
...
//# sourceMappingURL=e6440fdbc2c2e7c9450ab44f4d93f295abe43ae0.js.map