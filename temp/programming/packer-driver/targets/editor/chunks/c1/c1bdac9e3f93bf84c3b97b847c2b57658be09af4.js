    ...
    execute: function () {
      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        ...
        rotaView(vec2) {
          let x = vec2.x;
          let y = vec2.y;
          Quat.rotateAroundLocal(this._rotation, this._rotation, this._camera.node.forward, y);
          Quat.rotateAroundLocal(this._rotation, this._rotation, this._camera.node.right, x); // if (this._eulerP.x + x < -30 && this._eulerP.x + x > -90) { // x处角度的旋转限制 测试使用
          //     this._eulerP.x += x;
          // }
          // this._eulerP.y += y;
        }
...
//# sourceMappingURL=c1bdac9e3f93bf84c3b97b847c2b57658be09af4.js.map