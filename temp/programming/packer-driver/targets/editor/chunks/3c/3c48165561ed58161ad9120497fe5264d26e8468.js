System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CameraComponent, Component, misc, Quat, Vec3, GlobalConst, v3_1, Msg, MsgEvent, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, qt_1, forward, right, CameraControllerComp;
    ...
    execute: function () {
      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        ...
        rotaView(vec2) {
          ...
          let x = vec2.x;
          let y = vec2.y;
          x = misc.degreesToRadians(x); // Quat.rotateAround(this._rotation, this._rotation, this._camera.node.forward, y);
...
//# sourceMappingURL=3c48165561ed58161ad9120497fe5264d26e8468.js.map