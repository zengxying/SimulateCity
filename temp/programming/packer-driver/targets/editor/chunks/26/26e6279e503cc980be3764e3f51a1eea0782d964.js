System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, geometry, misc, Node, PhysicsSystem, Quat, screen, Vec3, v3_1, v3_2, v3_3, Msg, MsgEvent, CameraControllerComp, Util, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, qt_1, MapOperateComp;
    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        testRotaPos(addAngle) {
          ...
          const angle = misc.degreesToRadians(this.testAngle); // 转换成弧度 
          ...
          (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
            error: Error()
          }), Util) : Util).createSphere(this.node.parent, 1, this._position); // Res.instNode(this.sphere, this.node.parent, this._position);
...
//# sourceMappingURL=26e6279e503cc980be3764e3f51a1eea0782d964.js.map