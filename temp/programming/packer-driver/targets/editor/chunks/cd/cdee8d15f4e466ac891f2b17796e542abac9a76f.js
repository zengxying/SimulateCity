    ...
    execute: function () {
      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        ...
        rotaView(vec2) {
          // 旋转看着像是地图的旋转
          let x = vec2.x;
          let y = vec2.y; // Quat.rotateAround(this._rotation, this._rotation, this._camera.node.forward, y);
...
//# sourceMappingURL=cdee8d15f4e466ac891f2b17796e542abac9a76f.js.map