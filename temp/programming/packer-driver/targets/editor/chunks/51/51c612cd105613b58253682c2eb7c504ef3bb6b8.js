      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        getHitPointToGridPosition(vec2, out) {
          if (this.calculateHitPoint(vec2)) {
            ...
            let size = this.node.getComponent(BoxCollider).size;
            let width = size.x * this.node.scale.x / 2;
            let height = size.z * this.node.scale.z / 2;
...
//# sourceMappingURL=51c612cd105613b58253682c2eb7c504ef3bb6b8.js.map