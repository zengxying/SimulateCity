      ...
      _export("OperateComp", OperateComp = (_dec = ccclass('OperateComp'), _dec(_class = class OperateComp extends Component {
        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            ...
            let disPre = Vec2.distance(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            ...
            let preY = touches[0].getDelta(_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2).y;
            let curY = touches[1].getDelta(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1).y;
            touches[0].getLocation(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            ...
            let disCur = Vec2.distance(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2);
...
//# sourceMappingURL=4bf39ff0665ed0e5e338d03b14a0ff704fdcb370.js.map