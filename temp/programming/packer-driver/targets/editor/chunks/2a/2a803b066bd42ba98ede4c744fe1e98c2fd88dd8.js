      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        ...
        onEnable() {
          ...
          (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
            ...
            error: Error()
          }), MsgEvent) : MsgEvent).OP_TOUCH_ROTA, this.rotaView.bind(this)); // Msg.on(MsgEvent.OP_TOUCH_SCALE, this.scaleView.bind(this));
        }
...
//# sourceMappingURL=2a803b066bd42ba98ede4c744fe1e98c2fd88dd8.js.map