      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        ...
        onEnable() {
          (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
            ...
            error: Error()
          }), MsgEvent) : MsgEvent).OP_TOUCH_MOVE, this.moveView.bind(this)); // Msg.on(MsgEvent.OP_TOUCH_ROTA, this.rotaView.bind(this));
        ...
        moveView(vec2) {
          ...
          const scale = 1 + this._position.z / this.distanceY * 10;
        ...
        rotaView(vec2) {
          ...
          Quat.rotateAround(this._rotation, this._rotation, this._camera.node.right, x); // if (this._eulerP.x + x < -30 && this._eulerP.x + x > -90) { // x处角度的旋转限制 测试使用
          //     this._eulerP.x += x;
          // }
          // this._eulerP.y += y;
        }
...
//# sourceMappingURL=f669fe6d4cbee0ee1eaa51cf8b47edef316ec351.js.map