  ...
  return {
    ...
    execute: function () {
      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        ...
        static test(vec2) {
          v3_1.set(vec2.x, vec2.y, 0.5);

          this.ins._camera.screenToWorld(v3_1, v3_1);
      ...
      }, _class3.ins = void 0, _class3), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "moveSpeed", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=0a85ecd6b368391e1f2fa2edb99e5a99e3ace255.js.map