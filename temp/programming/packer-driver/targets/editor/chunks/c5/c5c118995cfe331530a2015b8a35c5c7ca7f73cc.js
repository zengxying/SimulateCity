  ...
  return {
    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        setRotaCamera(x) {
          const cameraNode = (_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
            error: Error()
          ...
          let rotax = x; // 计算角度的旋转坐标

          let angle = misc.degreesToRadians(rotax); // 转换成弧度 
          ...
          const dist = (_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1).length();
          const newx = dist * cosAngle * sinAngle;
          const newy = dist * sinAngle;
          const newz = dist * cosAngle * cosAngle;
...
//# sourceMappingURL=c5c118995cfe331530a2015b8a35c5c7ca7f73cc.js.map