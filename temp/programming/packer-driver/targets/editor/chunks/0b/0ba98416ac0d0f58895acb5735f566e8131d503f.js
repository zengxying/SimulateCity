  ...
  return {
    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        onEnable() {
          this.calculateRotaAxis(); // Msg.on(MsgEvent.OP_TOUCH_ROTA, this.rotaView.bind(this));
        ...
        testRotaPos(addAngle) {
          ...
          this._position.set(newX + this.originPos.x, this._position.y, newZ + this.originPos.z);
...
//# sourceMappingURL=0ba98416ac0d0f58895acb5735f566e8131d503f.js.map