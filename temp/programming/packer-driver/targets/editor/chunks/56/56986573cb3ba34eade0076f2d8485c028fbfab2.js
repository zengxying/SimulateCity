      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        _updateHitPoint(vec2) {
          (_crd && MapMgr === void 0 ? (_reportPossibleCrUseOfMapMgr({
            error: Error()
          }), MapMgr) : MapMgr).ins.calculateHitPoint(vec2);
        ...
        moveMap(vec2) {
          ...
          let canHit = (_crd && MapMgr === void 0 ? (_reportPossibleCrUseOfMapMgr({
            error: Error()
          }), MapMgr) : MapMgr).ins.calculateHitPoint(vec2);
...
//# sourceMappingURL=56986573cb3ba34eade0076f2d8485c028fbfab2.js.map