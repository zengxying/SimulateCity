System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec2, Input, input, KeyCode, v2, GlobalConst, v2_1, v2_2, v2_3, v2_4, Msg, MsgEvent, Util, Log, CameraControllerComp, _dec, _class, _crd, ccclass, property, OperateComp;
      ...
      _export("OperateComp", OperateComp = (_dec = ccclass('OperateComp'), _dec(_class = class OperateComp extends Component {
        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            ...
            var angle = (_crd && v2_4 === void 0 ? (_reportPossibleCrUseOfv2_4({
              error: Error()
            ...
            (_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_2) : v2_2).multiplyScalar(0.07);
            (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
              error: Error()
            }), Msg) : Msg).emit((_crd && MsgEvent === void 0 ? (_reportPossibleCrUseOfMsgEvent({
              error: Error()
            }), MsgEvent) : MsgEvent).OP_TOUCH_MOVE, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_2) : v2_2);
...
//# sourceMappingURL=c6e7c831fd79d6a62af1712aa637a4332206d4ef.js.map