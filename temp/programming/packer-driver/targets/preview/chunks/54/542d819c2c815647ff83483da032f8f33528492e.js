    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        setRotaCamera(x) {
          this._rotaAxisDirty = true;
          this.calculateRotaAxis();
          var wpos = (_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
            error: Error()
          ...
          var rotax = -(_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
            error: Error()
          }), GlobalConst) : GlobalConst).camera.node.eulerAngles.x + x;
          ...
          Vec3.transformQuat(_crd && v3_3 === void 0 ? (_reportPossibleCrUseOfv3_3({
            error: Error()
          }), v3_3) : v3_3, _crd && v3_3 === void 0 ? (_reportPossibleCrUseOfv3_3({
            error: Error()
          }), v3_3) : v3_3, (_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
            error: Error()
          }), GlobalConst) : GlobalConst).camera.node.rotation);
          (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
            error: Error()
...
//# sourceMappingURL=542d819c2c815647ff83483da032f8f33528492e.js.map