System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec2, Input, input, KeyCode, v2, GlobalConst, Msg, MsgEvent, Util, Log, CameraControllerComp, _dec, _class, _crd, ccclass, property, v2_1, v2_2, v2_3, OperateComp;
      ...
      _export("OperateComp", OperateComp = (_dec = ccclass('OperateComp'), _dec(_class = class OperateComp extends Component {
        ...
        onTouchStart(e) {
          ...
          (_crd && CameraControllerComp === void 0 ? (_reportPossibleCrUseOfCameraControllerComp({
            error: Error()
          }), CameraControllerComp) : CameraControllerComp).test(touches[0]._point);
        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            ...
            var disPre = Vec2.distance(v2_1, v2_2);
            Vec2.subtract(v2_3, v2_2, v2_1);
            var preY = touches[0].getDelta(v2_2).y;
            var curY = touches[1].getDelta(v2_1).y;
            touches[0].getLocation(v2_1);
            touches[1].getLocation(v2_2);
            var disCur = Vec2.distance(v2_1, v2_2);
            ...
            (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
              ...
              error: Error()
            }), MsgEvent) : MsgEvent).OP_TOUCH_MOVE, v2_2);
...
//# sourceMappingURL=5e34d9a029bd7cdaa63b2b0342932857d3c0f7bf.js.map