  ...
  return {
    ...
    execute: function () {
      ...
      _export("MapMgr", MapMgr = class MapMgr {
        ...
        graphicsMapLine() {
          var node = this.node;
          var box = node.getComponent(BoxCollider); // const lineBox = new Node("line-box");
          // node.addChild(lineBox);
          // let line = lineBox.addComponent(Line);

          var line = node.getComponentInChildren(Line);
          ...
          for (var x = 0; x < hGridCount; x++) {
            for (var y = 0; y < vGridCount; y++) {
              arr.push(v3(-(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
                error: Error()
...
//# sourceMappingURL=110809c995e384d57117cabc0f54763345f1b470.js.map