      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        setRotaCamera(x) {
          var wpos = (_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
            error: Error()
          }), GlobalConst) : GlobalConst).camera.node.worldPosition;
          Vec3.subtract(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1, wpos, this._centerPoint);
          (_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
            error: Error()
          }), GlobalConst) : GlobalConst).camera.node.right;
          ...
          (_crd && v3_3 === void 0 ? (_reportPossibleCrUseOfv3_3({
            error: Error()
          }), v3_3) : v3_3).set(this._position.x, this._centerPoint.y + newY, newZ + this._centerPoint.z);
          (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
            error: Error()
...
//# sourceMappingURL=51295e5f058a1399a22f304686451b7f51a4a94c.js.map