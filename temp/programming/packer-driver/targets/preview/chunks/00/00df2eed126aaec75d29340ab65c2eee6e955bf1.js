    ...
    execute: function () {
      ...
      _export("CameraControllerComp", CameraControllerComp = (_dec = ccclass('CameraControllerComp'), _dec2 = property({
        ...
        rotaView(vec2) {
          // 旋转看着像是地图的旋转
          var x = vec2.x;
          var y = vec2.y; // Quat.rotateAround(this._rotation, this._rotation, this._camera.node.forward, y);
...
//# sourceMappingURL=00df2eed126aaec75d29340ab65c2eee6e955bf1.js.map