  ...
  return {
    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        calculateRotaAxis() {
          var forward = (_crd && CameraControllerComp === void 0 ? (_reportPossibleCrUseOfCameraControllerComp({
            error: Error()
          }), CameraControllerComp) : CameraControllerComp).camera.node.forward;
          var pos = (_crd && CameraControllerComp === void 0 ? (_reportPossibleCrUseOfCameraControllerComp({
            error: Error()
...
//# sourceMappingURL=7eb40f2ba0ef0c5db8ee8b69f1cbce231cf2ba12.js.map