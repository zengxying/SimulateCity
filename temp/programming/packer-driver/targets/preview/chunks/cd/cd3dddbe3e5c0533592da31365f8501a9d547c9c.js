System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, BoxCollider, Component, geometry, MeshRenderer, misc, Node, Quat, screen, Vec2, Vec3, GlobalConst, ray, v3_1, v3_2, v3_3, worldMatrix, Util, MsgEvent, Msg, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, qt_1, mapHitPoint, MapOperateComp;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        getHitPointToGridPosition(vec2, out) {
          if (this.calculateHitPoint(vec2)) {
            Vec3.transformInverseRTS(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
              error: Error()
            }), v3_1) : v3_1, mapHitPoint, this.node.rotation, this.node.position, Vec3.ONE);
            this.node.inverseTransformPoint(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
              error: Error()
            }), v3_1) : v3_1, mapHitPoint); // let scaleX = GlobalConst.mapGridWidth / 20;
            // let scaleX = GlobalConst.mapGridWidth / 20;

            var size = this.node.getComponent(BoxCollider).size;
            var width = size.x * this.node.scale.x / 2;
            var height = size.z * this.node.scale.z / 2;
        ...
        moveMap(vec2) {
          ...
          var canHit = this.calculateHitPoint(vec2);
...
//# sourceMappingURL=cd3dddbe3e5c0533592da31365f8501a9d547c9c.js.map