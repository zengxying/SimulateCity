System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, BoxCollider, Line, MeshRenderer, Node, Quat, Vec3, geometry, v3, GlobalConst, ray, v3_1, worldMatrix, MapMgr, _crd, qt_1, mapHitPoint;
      ...
      _export("MapMgr", MapMgr = class MapMgr {
        ...
        getHitPointToGrid(vec2, out) {
          if (this.calculateHitPoint(vec2, mapHitPoint)) {
            ...
            var scaleX = (_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
              error: Error()
            }), GlobalConst) : GlobalConst).mapGridWidth / scale.x;
            var scaleY = (_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
              error: Error()
...
//# sourceMappingURL=f3618ebfcc9ac7ec838b83f8b5574307f47e6a63.js.map