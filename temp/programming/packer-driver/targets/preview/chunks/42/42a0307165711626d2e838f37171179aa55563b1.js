System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, misc, tween, v3, Vec2, v3_2, CameraControllerComp, _dec, _class, _crd, ccclass, property, tmpV3, Util;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Color', 'Component', 'Label', 'misc', 'Node', 'tween', 'v3', 'Vec2', 'Vec3']);
      ...
      _export("Util", Util = (_dec = ccclass("Util"), _dec(_class = class Util {
        ...
        */
        ...
        static getAngleBetweenVectors(vectorA, vectorB) {
          ...
          var angleDeg = misc.radiansToDegrees(angleRad); // 如果角度大于180度，则取补角（360度 - 角度）
        ...
        static getScreenToWorld(vec2, vec3) {
          console.log("转换出来的坐标:vec2 vec2", vec2.x, vec2.y);
          (_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_2) : v3_2).set(vec2.x, vec2.y, 0);
          return (_crd && CameraControllerComp === void 0 ? (_reportPossibleCrUseOfCameraControllerComp({
            error: Error()
          }), CameraControllerComp) : CameraControllerComp).camera.screenToWorld(_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_2) : v3_2, vec3);
        }
...
//# sourceMappingURL=42a0307165711626d2e838f37171179aa55563b1.js.map