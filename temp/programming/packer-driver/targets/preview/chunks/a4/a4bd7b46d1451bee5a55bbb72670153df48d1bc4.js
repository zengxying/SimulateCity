System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Line, MeshRenderer, Quat, Vec3, geometry, GlobalConst, ray, v3_1, worldMatrix, MapMgr, _crd, qt_1, mapHitPoint;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Line', 'MeshRenderer', 'Node', 'Quat', 'Vec2', 'Vec3', 'geometry']);
      ...
      _export("MapMgr", MapMgr = class MapMgr {
        ...
        graphicsMapLine() {
          var node = this.node;
          var line = node.addComponent(Line);
          line.positions;
        }
        /** 计算触发到地图上的点位, 传入屏幕坐标 */
...
//# sourceMappingURL=a4bd7b46d1451bee5a55bbb72670153df48d1bc4.js.map