System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec2, Vec3, Input, input, KeyCode, v2, misc, CameraControllerComp, MapOperateComp, GlobalConst, v2_2, v2_1, v2_3, v2_4, v3_1, v3_2, Util, MsgEvent, Msg, _dec, _class, _crd, ccclass, property, lv, OperateComp;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      MapOperateComp = _unresolved_3.MapOperateComp;
    }, function (_unresolved_4) {
      GlobalConst = _unresolved_4.GlobalConst;
      v2_2 = _unresolved_4.v2_2;
      v2_1 = _unresolved_4.v2_1;
      v2_3 = _unresolved_4.v2_3;
      v2_4 = _unresolved_4.v2_4;
      v3_1 = _unresolved_4.v3_1;
      v3_2 = _unresolved_4.v3_2;
    }, function (_unresolved_5) {
      Util = _unresolved_5.Util;
    }, function (_unresolved_6) {
      MsgEvent = _unresolved_6.MsgEvent;
    }, function (_unresolved_7) {
      Msg = _unresolved_7.Msg;
    }],
    execute: function () {
      _crd = true;
      ...
      __checkObsolete__(['_decorator', 'Component', 'Quat', 'Vec2', 'Vec3', 'Input', 'game', 'EventTouch', 'EventMouse', 'input', 'EventKeyboard', 'KeyCode', 'v2', 'misc', 'macro', 'geometry']);
      ...
      _export("OperateComp", OperateComp = (_dec = ccclass('OperateComp'), _dec(_class = class OperateComp extends Component {
        ...
        onTouchStart(e) {
          ...
          if (touches.length > 1) {} else {
            touches[0].getLocation(_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2);
            (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
              error: Error()
              ...
              error: Error()
            }), MsgEvent) : MsgEvent).OP_RESET_CLICK_POINT, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2);
          }
          ...
          camera.worldToScreen(this.node.worldPosition, _crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1);
          camera.screenToWorld(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          ...
          console.log("v3_2.x:" + (_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
            error: Error()
          }), v3_2) : v3_2).x + " v3_2.y:" + (_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
            error: Error()
          }), v3_2) : v3_2).y + " v3_2.z:" + (_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
            error: Error()
          }), v3_2) : v3_2).z + " ");
        }
        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            touches[0].getPreviousLocation(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1);
            touches[1].getPreviousLocation(_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2);
            var disPre = Vec2.distance(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2);
            Vec2.subtract(_crd && v2_3 === void 0 ? (_reportPossibleCrUseOfv2_3({
              error: Error()
            }), v2_3) : v2_3, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2, _crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1);
            touches[0].getPreviousLocation(_crd && v2_4 === void 0 ? (_reportPossibleCrUseOfv2_4({
              error: Error()
            }), v2_4) : v2_4).subtract(touches[1].getPreviousLocation(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1));
            touches[0].getLocation(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1).subtract(touches[1].getLocation(_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2));
            var angle = misc.radiansToDegrees((_crd && v2_4 === void 0 ? (_reportPossibleCrUseOfv2_4({
              error: Error()
            }), v2_4) : v2_4).signAngle(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1)); // y轴旋转

            var preY = touches[0].getDelta(_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2).y;
            var curY = touches[1].getDelta(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1).y;
            touches[0].getLocation(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1);
            touches[1].getLocation(_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2);
            var disCur = Vec2.distance(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2);
            ...
            scale = disPre - disCur;
            (_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            ...
            (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
              ...
              error: Error()
            }), MsgEvent) : MsgEvent).OP_TOUCH_ROTA, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            ...
            (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
              error: Error()
            }), Util) : Util).getScreenToWorld(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            ...
            (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
              error: Error()
            }), Util) : Util).getScreenToWorld(_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            ...
            (_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            ...
            (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
              ...
              error: Error()
            }), MsgEvent) : MsgEvent).OP_TOUCH_MOVE, _crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_1) : v2_1);
            (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
              error: Error()
              ...
              error: Error()
            }), MsgEvent) : MsgEvent).OP_TOUCH_MOVE_MAP, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_2) : v2_2);
          }
        }
        ...
        onKeyDown(event) {
          ...
          if (keyCode == KeyCode.KEY_Q) {
            (_crd && MapOperateComp === void 0 ? (_reportPossibleCrUseOfMapOperateComp({
              error: Error()
            }), MapOperateComp) : MapOperateComp).ins.calculateRotaAxis();
            (_crd && MapOperateComp === void 0 ? (_reportPossibleCrUseOfMapOperateComp({
              error: Error()
            }), MapOperateComp) : MapOperateComp).ins.setRotaPos(10); // GlobalConst.cameraMoveDir.y = -1;
...
//# sourceMappingURL=683b303c03173797d46481c1a114a5f69db290d3.js.map