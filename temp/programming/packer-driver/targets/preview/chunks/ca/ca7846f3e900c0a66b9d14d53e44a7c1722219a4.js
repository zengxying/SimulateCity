        ...
        getHitPointToGridPosition(vec2, out) {
          if (this.calculateHitPoint(vec2)) {
            ...
            console.log("hitpointx:" + (_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
              ...
              error: Error()
            }), v3_1) : v3_1).z); // out.x = (Math.floor(v3_1.x / GlobalConst.mapGridWidth) + 0.5) * GlobalConst.mapGridWidth;
            // out.y = out.y;
...
//# sourceMappingURL=ca7846f3e900c0a66b9d14d53e44a7c1722219a4.js.map