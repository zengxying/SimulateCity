    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        setRotaCamera2(x) {
          var cameraNode = (_crd && GlobalConst === void 0 ? (_reportPossibleCrUseOfGlobalConst({
            error: Error()
          }), GlobalConst) : GlobalConst).camera.node; // const wpos = cameraNode.parent.worldPosition;
          // Vec3.subtract(v3_1, wpos, this._centerPoint); // 方向向量
          // const rotaX = cameraNode.eulerAngles.x;
          // let rotax = x;
...
//# sourceMappingURL=b89c68c26e490b9d8cb228fddf9317912d2c355d.js.map