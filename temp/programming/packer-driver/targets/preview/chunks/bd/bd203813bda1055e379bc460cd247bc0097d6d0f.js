System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, geometry, misc, Node, PhysicsSystem, Quat, screen, Vec3, v3_1, v3_2, v3_3, Msg, MsgEvent, CameraControllerComp, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, qt_1, MapOperateComp;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        slide: true,
        range: [0.05, 0.5, 0.01]
      }), _dec3 = property(Node), _dec(_class = (_class2 = class MapOperateComp extends Component {
        constructor() {
          super(...arguments);
        ...
        calculateRotaAxis() {
          if (!this._rotaAxisDirty) return; // this._rotaAxisDirty = false;
        ...
        rotaView(vec2) {
          ...
          var x = vec2.x;
          var y = vec2.y;
          this._eulerP.y += misc.radiansToDegrees(y); // this._calculateRotaPos(y);
          // console.log("yyyy----->" + y);

          this._calculateRotaPos2(y); // Quat.rotateAround(this._rotation, this._rotation, this.node.forward, y);
        ...
        _calculateRotaPos(radian) {
          ...
          var localPosition = this.node.getPosition(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1).subtract(this._centerPoint); // 计算旋转后的位置

          var angle = misc.degreesToRadians(radian); // 转换成弧度
...
//# sourceMappingURL=bd203813bda1055e379bc460cd247bc0097d6d0f.js.map