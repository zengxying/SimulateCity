System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, geometry, PhysicsSystem, Quat, screen, Vec3, v3_1, v3_2, v3_3, Msg, MsgEvent, CameraControllerComp, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, MapOperateComp;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Camera', 'CameraComponent', 'Component', 'director', 'EventTouch', 'game', 'geometry', 'Node', 'PhysicsSystem', 'Quat', 'screen', 'sp', 'Vec2', 'Vec3']);
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        rotaView(vec2) {
          ...
          Vec3.subtract(_crd && v3_3 === void 0 ? (_reportPossibleCrUseOfv3_3({
            error: Error()
          }), v3_3) : v3_3, this._centerPoint, _crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1);
          ...
          this._position.set((_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1).add(_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
            error: Error()
          }), v3_2) : v3_2)); // Quat.rotateAround(this._rotation, this._rotation, this.node.forward, y);
...
//# sourceMappingURL=2dcbedbf089fc690781234baaf61b9b1e9f40da3.js.map