System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec2, Vec3, Input, input, KeyCode, v2, misc, geometry, GlobalConst, ray, v2_1, v2_2, v2_3, v2_4, v3_1, v3_2, Msg, MsgEvent, Util, Log, CameraControllerComp, MapOperateComp, _dec, _class, _crd, ccclass, property, OperateComp;
      ...
      _export("OperateComp", OperateComp = (_dec = ccclass('OperateComp'), _dec(_class = class OperateComp extends Component {
        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            ...
            var disPre = Vec2.distance(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            ...
            var preY = touches[0].getDelta(_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_2) : v2_2).y;
            var curY = touches[1].getDelta(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_1) : v2_1).y;
            touches[0].getLocation(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            ...
            var disCur = Vec2.distance(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_1) : v2_1, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_2) : v2_2);
            ...
            var realAngle = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
              error: Error()
            ...
            camera.screenPointToRay((_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_2) : v2_2).x, (_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_2) : v2_2).y, _crd && ray === void 0 ? (_reportPossibleCrUseOfray({
              error: Error()
            }), ray) : ray);
            var dis2 = geometry.intersect.rayModel(_crd && ray === void 0 ? (_reportPossibleCrUseOfray({
              error: Error()
            }), ray) : ray, (_crd && MapOperateComp === void 0 ? (_reportPossibleCrUseOfMapOperateComp({
              error: Error()
            }), MapOperateComp) : MapOperateComp).ins._meshRender.model);

            if (dis2) {
              (_crd && ray === void 0 ? (_reportPossibleCrUseOfray({
                error: Error()
              }), ray) : ray).computeHit(_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
                error: Error()
              }), v3_2) : v3_2, dis2); // 性能要好些
            }
            ...
            var dis = Vec3.distance(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
              error: Error()
            }), v3_1) : v3_1, _crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
              error: Error()
            }), v3_2) : v3_2);
...
//# sourceMappingURL=ef1d6cc875fef90445cd16121ec4504e0912f64b.js.map