    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        calculateRotaAxis() {
          ...
          this.dir = this.node.getPosition(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
        ...
        testRotaPos(radian) {
          ...
          var localPosition = this.dir; // 计算旋转后的位置  每次旋转的值加上本身的旋转度数

          var angle = misc.degreesToRadians(this.testRadian); // 转换成弧度 
        ...
        update(dt) {
          var t = Math.min(dt / this.damp, 1); // this.updateRotation(t);
          // // position
...
//# sourceMappingURL=b1e56f7f7894a321ff246da2470186c5584f3075.js.map