      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        _calculateRotaPos(radian) {
          ...
          (_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1).set(this.node.eulerAngles);
          this.node.lookAt(this._centerPoint);

          this._eulerP.set(this.node.eulerAngles);

          this.node.eulerAngles = _crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1;
        }
...
//# sourceMappingURL=8a7772e9bb14712153989d81abab71392bca99f6.js.map