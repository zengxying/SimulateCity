System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec2, Vec3, Input, input, KeyCode, v2, misc, GlobalConst, v2_1, v2_2, v2_3, v2_4, v3_1, v3_2, Msg, MsgEvent, Util, CameraControllerComp, MapOperateComp, _dec, _class, _crd, ccclass, property, lv, OperateComp;
      ...
      _export("OperateComp", OperateComp = (_dec = ccclass('OperateComp'), _dec(_class = class OperateComp extends Component {
        ...
        onTouchStart(e) {
          ...
          if (touches.length > 1) {} else {
            ...
            (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
              ...
              error: Error()
            }), MsgEvent) : MsgEvent).OP_TOUCH_START, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_2) : v2_2);
          }
        }
        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            ...
            console.log("move----->" + (_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            ...
            var dis = Vec3.distance(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
              ...
              error: Error()
            }), v3_2) : v3_2); // console.log("总的移动长度：----> " + dis);
...
//# sourceMappingURL=19c1b21a4ec31d7ec1c199321db01b5359f2a0be.js.map