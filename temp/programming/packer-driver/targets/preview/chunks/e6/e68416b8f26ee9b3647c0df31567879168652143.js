System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec2, Input, input, KeyCode, v2, GlobalConst, Msg, MsgEvent, Util, Log, _dec, _class, _crd, ccclass, property, v2_1, v2_2, v2_3, OperateComp;
        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            ...
            (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
              ...
              error: Error()
            }), MsgEvent) : MsgEvent).OP_TOUCH_SCALE, scale);
            (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
              error: Error()
            }), Msg) : Msg).emit((_crd && MsgEvent === void 0 ? (_reportPossibleCrUseOfMsgEvent({
              error: Error()
...
//# sourceMappingURL=e68416b8f26ee9b3647c0df31567879168652143.js.map