System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, builtinResMgr, Material, MeshRenderer, misc, Node, Primitive, tween, v3, Vec2, GlobalConst, _dec, _class, _crd, ccclass, property, tmpV3, Util;
      ...
      _export("Util", Util = (_dec = ccclass("Util"), _dec(_class = class Util {
        ...
        */
        ...
        static createSphere(parent, radius, pos) {
          ...
          var mesh = new Primitive(Primitive.PrimitiveType.SPHERE); //@ts-ignore
          ...
          material.initialize({
            ...
            defines: {
              USE_TEXTURE: true // USE_INSTANCING: true 
          ...
          node.layer = parent.layer; // node.setScale(radius, radius, radius);
        }
...
//# sourceMappingURL=88910cf6db5886502835c1964be25e240432e416.js.map