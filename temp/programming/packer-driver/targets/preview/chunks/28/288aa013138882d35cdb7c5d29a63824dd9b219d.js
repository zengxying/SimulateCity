System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CanvasComponent, Component, geometry, MeshRenderer, misc, Node, Quat, screen, Vec2, Vec3, GlobalConst, ray, v3_1, v3_2, v3_3, Util, MsgEvent, Msg, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, qt_1, MapOperateComp;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Camera', 'CameraComponent', 'CanvasComponent', 'Component', 'director', 'EventTouch', 'game', 'geometry', 'MeshRenderer', 'misc', 'Node', 'PhysicsSystem', 'Quat', 'screen', 'sp', 'Vec2', 'Vec3']);
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        onEnable() {
          ...
          (_crd && Msg === void 0 ? (_reportPossibleCrUseOfMsg({
            ...
            error: Error()
          }), MsgEvent) : MsgEvent).OP_RESET_CLICK_POINT, this.calculateHitPoint.bind(this));
        }
        ...
        calculateHitPoint(vec2) {
          ...
          var dis = geometry.intersect.rayModel(_crd && ray === void 0 ? (_reportPossibleCrUseOfray({
            error: Error()
        ...
        moveView(vec2) {
          ...
          var camera = this.node.parent.getChildByName("Canvas").getComponent(CanvasComponent).cameraComponent;
          ...
          (_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1).z = 1 - (_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1).z - camera.near / camera.far;
...
//# sourceMappingURL=288aa013138882d35cdb7c5d29a63824dd9b219d.js.map