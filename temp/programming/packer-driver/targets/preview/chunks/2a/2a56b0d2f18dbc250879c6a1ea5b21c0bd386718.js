        ...
        getHitPointToGridPosition(vec2, out) {
          if (this.calculateHitPoint(vec2)) {
            Vec3.subtract(_crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
              error: Error()
            }), v3_2) : v3_2, mapHitPoint, this.node.worldPosition);
            Vec3.transformInverseRTS(_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
              error: Error()
            }), v3_1) : v3_1, _crd && v3_2 === void 0 ? (_reportPossibleCrUseOfv3_2({
              error: Error()
            }), v3_2) : v3_2, this.node.rotation, this.node.position, Vec3.ONE);
...
//# sourceMappingURL=2a56b0d2f18dbc250879c6a1ea5b21c0bd386718.js.map