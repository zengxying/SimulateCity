System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec2, Vec3, Input, input, KeyCode, v2, GlobalConst, v2_1, v2_2, v2_3, v2_4, v3_1, v3_2, Msg, MsgEvent, Util, Log, CameraControllerComp, _dec, _class, _crd, ccclass, property, OperateComp;
        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            ...
            touches[0].getPreviousLocation(_crd && v2_4 === void 0 ? (_reportPossibleCrUseOfv2_4({
              error: Error()
            }), v2_4) : v2_4).add(touches[1].getPreviousLocation(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_1) : v2_1)).multiplyScalar(0.5);
            touches[0].getLocation(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_1) : v2_1).add(touches[1].getLocation(_crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_2) : v2_2)).multiplyScalar(0.5);
            (_crd && v2_4 === void 0 ? (_reportPossibleCrUseOfv2_4({
              error: Error()
            }), v2_4) : v2_4).subtract(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_1) : v2_1);
            var angle = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
              error: Error()
            }), Util) : Util).getAngleXVectors(_crd && v2_4 === void 0 ? (_reportPossibleCrUseOfv2_4({
              error: Error()
            }), v2_4) : v2_4);
            ...
            (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
              error: Error()
            }), Log) : Log).log("on touch move:realAngle---> ", angle);
          } else {
            return;
            var lv = 0.05;
            touches[0].getPreviousLocation(_crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_({
...
//# sourceMappingURL=8d990832e3165f271859b9f9d3ec76fae4314489.js.map