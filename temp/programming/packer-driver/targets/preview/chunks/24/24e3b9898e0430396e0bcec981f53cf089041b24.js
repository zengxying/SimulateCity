    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        rotaView(vec2) {
          ...
          var x = vec2.x;
          var y = vec2.y;
          this.setRotaCamera(x); // this.setRotaPos(y);
          // console.log("yyyy----->" + y);
        ...
        setRotaCamera(x) {
          ...
          angle += cameraNode.eulerAngles.x;
          ...
          var dist = (_crd && v3_1 === void 0 ? (_reportPossibleCrUseOfv3_({
            error: Error()
          }), v3_1) : v3_1).length();
          var newx = dist * cosAngle * sinAngle;
          var newy = dist * sinAngle;
          var newz = dist * cosAngle * cosAngle;
          (_crd && v3_3 === void 0 ? (_reportPossibleCrUseOfv3_3({
            error: Error()
          }), v3_3) : v3_3).set(wpos.x, this._centerPoint.y + newY, newZ + this._centerPoint.z);
          (_crd && v3_3 === void 0 ? (_reportPossibleCrUseOfv3_3({
            error: Error()
          }), v3_3) : v3_3).set(this._centerPoint.x + newx, this._centerPoint.y + newy, newz + this._centerPoint.z); // Vec3.transformQuat(v3_3, v3_3, GlobalConst.camera.node.rotation);
...
//# sourceMappingURL=24e3b9898e0430396e0bcec981f53cf089041b24.js.map