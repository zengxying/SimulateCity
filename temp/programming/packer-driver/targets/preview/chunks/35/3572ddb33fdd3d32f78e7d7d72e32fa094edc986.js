System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, geometry, MeshRenderer, misc, Node, Quat, screen, Vec3, v3_1, v3_2, v3_3, Msg, MsgEvent, CameraControllerComp, Util, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, qt_1, MapOperateComp;
    ...
    execute: function () {
      ...
      _export("MapOperateComp", MapOperateComp = (_dec = ccclass('MapOperateComp'), _dec2 = property({
        ...
        calculateRotaAxis() {
          ...
          console.time("射线检测时间：");
          var dis = geometry.intersect.rayMesh(this._cameraRay, this._meshRender.mesh);

          if (dis) {
            this._cameraRay.computeHit(this._centerPoint, dis);
...
//# sourceMappingURL=3572ddb33fdd3d32f78e7d7d72e32fa094edc986.js.map