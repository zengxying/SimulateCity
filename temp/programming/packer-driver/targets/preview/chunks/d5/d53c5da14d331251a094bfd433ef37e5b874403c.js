        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            ...
            var angle = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
              error: Error()
            }), Util) : Util).getAngleBetweenVectors(_crd && v2_4 === void 0 ? (_reportPossibleCrUseOfv2_4({
              error: Error()
            }), v2_4) : v2_4, _crd && v2_1 === void 0 ? (_reportPossibleCrUseOfv2_({
              error: Error()
            }), v2_1) : v2_1); // y轴旋转
...
//# sourceMappingURL=d53c5da14d331251a094bfd433ef37e5b874403c.js.map