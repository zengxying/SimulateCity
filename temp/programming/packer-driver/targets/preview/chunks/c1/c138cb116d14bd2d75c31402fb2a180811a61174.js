System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec2, Vec3, Input, input, KeyCode, v2, GlobalConst, v2_1, v2_2, v2_3, v3_1, v3_2, Msg, MsgEvent, Util, Log, CameraControllerComp, _dec, _class, _crd, ccclass, property, OperateComp;
      ...
      _export("OperateComp", OperateComp = (_dec = ccclass('OperateComp'), _dec(_class = class OperateComp extends Component {
        ...
        onTouchMove(e) {
          ...
          if (touches.length > 1) {
            ...
            if (curY > 0 && preY > 0) {
              angle = realAngle; // rota = Math.min(curY, preY);
            } else if (curY < 0 && preY < 0) {
              angle = realAngle; // rota = Math.max(curY, preY);
            } else {} // scale = disPre - disCur;
            ...
            (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
              error: Error()
            }), Log) : Log).log("on touch move:touches---> ", scale, _crd && v2_2 === void 0 ? (_reportPossibleCrUseOfv2_2({
              error: Error()
            }), v2_2) : v2_2);
          } else {
            return;
...
//# sourceMappingURL=c138cb116d14bd2d75c31402fb2a180811a61174.js.map